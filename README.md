...
MathJax is a reviewed, versioned site asset under
[`assets/vendor/`](assets/vendor/README.md), not a Node build dependency. The
curated local runtime covers Eyvan's shipped math examples and can be extended
when a site needs additional TeX packages or font ranges.
...
- **Vendored Runtime Libraries**: The MathJax version, integrity metadata, curated runtime boundary, licenses, and update instructions are documented in [`assets/vendor/README.md`](assets/vendor/README.md).
